...
def main(args):
    ...
    buff_surface_raw = buff.get_surface()
    ...
    while True:
        ...
        for i in range(1000):
            gpu.draw_triangle(buff.array, np.array([0,0]), np.array([0, 120]), np.array([200, 120]), gpu.Color(255, 0, 0).array)
        ...
        pygame.transform.scale2x(buff_surface_raw, buff_target)
